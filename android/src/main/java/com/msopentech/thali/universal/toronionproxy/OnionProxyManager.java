...
import static com.msopentech.thali.universal.toronionproxy.FileUtilities.setToReadOnlyPermissions;
...
public class OnionProxyManager {
    ...
    private void eatStream(final InputStream inputStream, final boolean isError) {
        new Thread() {
            @Override
            public void run() {
