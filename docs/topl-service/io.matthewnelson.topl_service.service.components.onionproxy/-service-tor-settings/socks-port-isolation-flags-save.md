[topl-service](../../index.md) / [io.matthewnelson.topl_service.service.components.onionproxy](../index.md) / [ServiceTorSettings](index.md) / [socksPortIsolationFlagsSave](./socks-port-isolation-flags-save.md)
